...
I don't know if they're aware of my condition or how it's impacted me. I'm not sure it would've changed anything or if they'd care. All I know is I don't know what happened or why. Nobody else understands either. Normally, when a relationship with somebody falls apart, we can point to some legible event or emotion: an argument, betrayal, break-up, whatever. In this case, there was _no_ precipitating event nor conversation, _so I don't even know what the problem was_. I am honestly not even sure they could explain themself if asked.[^2]
